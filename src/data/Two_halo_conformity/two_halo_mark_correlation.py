...
__copyright__  =["Copyright 2017 Victor Calderon, 2-halo Mark Correlation"]
__email__      =['victor.calderon@vanderbilt.edu']
__maintainer__ =['Victor Calderon']
"""
Computes the 2-halo Mark correlation function for SDSS DR7
"""
...
def directory_skeleton(param_dict, proj_dict):
    ...
    pickdir = '{0}/processed/{1}/catl_pickle_files/{2}/{3}/'.format(
                    proj_dict['data_dir'],
                    path_prefix          ,
                    param_dict['corr_type'],
                    param_dict['param_str'])
    ### MCF Output directory - Galaxy Pairs
