...
def get_exec_string(params_pd, param_dict):
    ...
    if param_dict['analysis_type']=='calc':
        FRAC_file = 'one_halo_conformity_quenched_fractions.py'
    elif param_dict['analysis_type']=='plots':
        FRAC_file = 'one_halo_conformity_quenched_fractions_plots.py'
    ##
...
def file_construction_and_execution(params_pd, param_dict):
    ...
    outfile_name = 'one_halo_conformity_quenched_fractions_{0}_run.sh'.format(param_dict['analysis_type'])
    ...
    with open(outfile_path, 'wb') as out_f:
        ...
        out_f.write( """WINDOW_NAME="One_Halo_FRAC_STAT_conformity_{0}"\n""".format(param_dict['analysis_type']).encode())
        ...
        out_f.write(b"""conda activate ${ENV_NAME}\n""")
        out_f.write(b"""###\n""")
        ...
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_DATA} -X stuff $"conda deactivate;"\n""")
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_DATA} -X stuff $'\\n'\n""")
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_DATA} -X stuff $"conda activate ${ENV_NAME};"\n""")
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_DATA} -X stuff $'\\n'\n""")
        ...
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_MOCKS} -X stuff $"conda deactivate;"\n""")
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_MOCKS} -X stuff $'\\n'\n""")
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_MOCKS} -X stuff $"conda activate ${ENV_NAME};"\n""")
        out_f.write(b"""screen -S ${WINDOW_NAME} -p ${WINDOW_MOCKS} -X stuff $'\\n'\n""")
